...
{
    public partial class BookstorContext : DbContext
    {
        public BookstorContext()
        {
        }

        public BookstorContext(DbContextOptions<BookstorContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Server=localhost;Port=5432;Database=Bookstor;User Id=postgres;Password=root;");
            }
        }
