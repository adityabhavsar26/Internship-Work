...
const Category: React.FC = () => {
  ...
  const [categoryRecords, setCategoryRecords] = useState<BaseList<CategoryModel[]>>({totalRecords: 0, results: []});
      ...
      <div className="container">
        ...
        <TableContainer>
          <Table aria-label="simple table">
            ...
            <TableBody>
              {categoryRecords?.results?.map((row: CategoryModel, index: number) => (
                <TableRow key={row.id}>
              ...
              {!categoryRecords?.results.length && (
        ...
        <TablePagination
          ...
          component="div"
          count={categoryRecords?.results.length ? categoryRecords.totalRecords : 0}
